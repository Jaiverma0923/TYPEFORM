...
Tables: creators, forms, form_themes, logic_rules, draft_responses, questions, form_responses, answers. Alembic migration: `alembic upgrade head`. The seed command creates default creator `1`, Customer Feedback (published, slug `customer-feedback-demo`) and Event Registration (draft), all question types, and analytics-ready responses.
