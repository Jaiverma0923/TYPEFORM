...
export default async function FormAnalyticsRoute({ params }: AnalyticsRouteProps) {
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-page px-4">
        <div className="max-w-md rounded-lg border border-border bg-surface p-6 text-center shadow-sm">
          <h1 className="text-xl font-medium text-primary">Invalid analytics route</h1>
  ...
  return <AnalyticsPage formId={parsedFormId} />;
}
